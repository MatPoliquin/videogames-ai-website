...
*   Supports DDR3 which is cheaper then DDR4 with praticaly no performance difference
*   Supports Ubuntu, Windows 10 and 11 quite well
*   Supports virtualization
*   Turbo boost unlock works with this motherboard
*   Reliable and runs at decent temperatures
